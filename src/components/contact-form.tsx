    ...
    <form onSubmit={onSubmit} className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          required
          autoComplete="email"
          className="rounded-md border bg-transparent px-3 py-2 text-base outline-none placeholder:text-muted-foreground focus-visible:border-ring"
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          required
          rows={4}
          className="resize-y rounded-md border bg-transparent px-3 py-2 text-base outline-none placeholder:text-muted-foreground focus-visible:border-ring"
