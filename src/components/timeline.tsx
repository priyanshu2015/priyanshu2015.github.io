 ...
 *
 * The publication's name is the credential here, so it leads. No scraped article
 * thumbnails: a masthead someone recognises does more for trust than a stock photo, and
 * it doesn't rot when the publication reshuffles its CDN.
 */
function PressLinks({
  links,
}: {
