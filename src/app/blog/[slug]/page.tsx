...
export default async function PostPage({
  ...
  return (
    <article>
      ...
      <div className="prose max-w-none dark:prose-invert prose-headings:font-semibold prose-headings:tracking-tight prose-a:font-normal prose-a:underline-offset-2 prose-img:rounded-md prose-img:border">
        <MDXRemote
          source={post.content}
