...
description: |
  Design patterns for structuring a Django project, from a single app on one
  server through multi-domain routing, independent deploys of the same codebase,
  separate user tables, and microservices, with the trade-offs of each.
